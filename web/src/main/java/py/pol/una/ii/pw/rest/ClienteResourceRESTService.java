...
public class ClienteResourceRESTService {
    ...
    /**
     * Creates a new cliente from the values provided. Performs validation, and
    ...
    /**
     * <p>
     * Validates the given Cliente variable and throws validation exceptions
     * based on the type of error. If the error is standard bean validation
     * errors then it will throw a ConstraintValidationException with the set of
     * the constraints violated.
     * </p>
     * <p>
     * If the error is caused because an existing cliente with the same email is
     * registered it throws a regular validation exception so that it can be
     * interpreted separately.
     * </p>
     * 
     * @param cliente
     *            Cliente to be validated
     * @throws ConstraintViolationException
     *             If Bean Validation errors exist
     * @throws ValidationException
     *             If cliente with the same email already exists
     */
    private void validateCliente(Cliente cliente)
            throws ConstraintViolationException, ValidationException {

        // Create a bean validator and check for issues.
        Set<ConstraintViolation<Cliente>> violations = validator
                .validate(cliente);
    ...
    /**
     * Checks if a cliente with the same email address is already registered.
     * This is the only way to easily capture the
     * "@UniqueConstraint(columnNames = "email")" constraint from the Cliente
     * class.
     * 
     * @param email
     *            The email to check
