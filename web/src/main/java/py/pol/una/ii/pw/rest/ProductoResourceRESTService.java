...
public class ProductoResourceRESTService {
    ...
    /**
     * <p>
     * Validates the given Producto variable and throws validation exceptions
     * based on the type of error. If the error is standard bean validation
     * errors then it will throw a ConstraintValidationException with the set of
     * the constraints violated.
     * </p>
     * <p>
     * If the error is caused because an existing producto with the same email
     * is registered it throws a regular validation exception so that it can be
     * interpreted separately.
     * </p>
     * 
     * @param producto
     *            Producto to be validated
    ...
    private void validateProducto(Producto producto)
        ...
        Set<ConstraintViolation<Producto>> violations = validator
                .validate(producto);
